...
const historia = [
	{
		...
		opcoes: ["continuar caminhando pelo computador", "sair correndo e ir para fora do computador"],
		regras: {
	...
	},
	{
		...
		opcoes: ["pisar em cima do arquivo para o corromper", "esquecer a raiva do trabalho e continuar caminhando"],
		regras: {
	...
	},
	{
		...
		opcoes: ["esperar parado para ver se o vírus para em algum momento", "tentar fazer alguma coisa mesmo sem desbloquear o computador",],
		regras: {
	...
	{
		texto: "Atenção! Durante seu percurso, você encontrou um desafio matemático. Para prosseguir, você precisa responder corretamente à seguinte questão: \"Quantas raízes tem o seguinte polinômio? X^4+2x^3+x^2-4x.\" Para responder, digite o número de raízes na caixa de texto.",
		opcoes: ["4", "2", "5", "10"],
		regras: {
			"4": 9,
			"2": 9,
	...
	{
		texto: "Você errou a resposta! A resposta correta do desafio era 5, já que o grau do polinômio corresponde ao expoente mais alto presente na equação, neste caso o número 5.",
		opcoes: ["voltar ao início"],
		regras: {
			"voltar ao início": 0,
			"1": 0,
	...
	{
		texto: "Parabéns! Você acertou a resposta! Agora pode seguir seu caminho.",
		opcoes: ["continuar a história",],
		regras: {
	...
	},
	{
		...
		opcoes: ["remover o disco C do computador e ver o que acontece", "desistir dessa ideia e procurar alguma outra solução"],
		regras: {
	...
	{
		texto: "Você errou a resposta! Na verdade, a resposta correta é 30 segundos. Primeiro, temos que pegar o tamanho total do arquivo (233 mb) e subtrair 128, que é a quantidade que o navegador indica que já foi baixada. O resultado que temos é 105, ou seja, que faltam 105 mb a serem baixados do arquivo. Com base nisso, ignoramos os outros 128 mb que já foram baixados e apenas dividimos os 105 que faltam pela velocidade do download, que é 3,5 mb/s. Assim, 105mb/3,5mb/s=30s para completar o download.",
		opcoes: ["voltar ao início",],
		regras: {
			"voltar ao início": 0,
			"1": 0,
	...
	{
		texto: "Parabéns! Você acertou a resposta! Agora pode seguir com a história",
		opcoes: ["continuar a história",],
		regras: {
	...
	},
	{
		...
		opcoes: ["processador", "teclado", "mouse", "alto-falante",],
		regras: {
			"processador": 17,
			"teclado": 18,
			"mouse": 19,
	...
	},
	{
		...
		opcoes: ["ir para a próxima história",],
		regras: {
...
function processarComando(comando) {
	...
	if (comando in regras) {
		...
		falarLeitor("Nova fase carregada");
			}
	} else {
