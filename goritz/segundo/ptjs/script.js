//Olá Mundo!
function olaMundo() {
    document.getElementById("outputResult").innerHTML = "Olá Mundo!";
  ...
  function nomeDigitado() {
    document.getElementById("outputResult").innerHTML = "Olá, " + nome.value;
  }
  ...
  function calcular() {
    ...
    if (sel == "opcao1") {
      ...
      document.getElementById("outputResult").innerHTML = resultado.toString();
    } else if (sel == "opcao2") {
      const resultado = parseFloat(primNum) - parseFloat(segmNum);
      document.getElementById("outputResult").innerHTML = resultado.toString();
    } else if (sel == "opcao3") {
