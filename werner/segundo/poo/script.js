...
class Cadeira {
    ...
    correr() {
        document.getElementById("mostrar").innerHTML = this.nome + " é uma cadeira, meio obvio que nao pode correr mas pode atirar ela em alguem";
        console.log("${this.nome} é uma cadeira,meio obvio que nao pode correr mas pode atirar ela em alguem");
    }
}
